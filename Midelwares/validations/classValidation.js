...
const childrenArrayCustmValidations = async (value) => {
...
const supervisorCustmValidations = async (value) => {
...
exports.insertValidator = [
  ...
  body("supervisor").isMongoId().withMessage(" supervisor id should be int").custom(supervisorCustmValidations),
  body("children").isArray()
    .withMessage("class classren should be Array").custom(childrenArrayCustmValidations),
];
exports.updateValidator = [
  ...
  body("name").optional()
    ...
    .isLength({ min: 2 })
    .withMessage(" class name lenght>5"),
  body("supervisor").optional().isMongoId().withMessage(" supervisor id should be int").custom(supervisorCustmValidations),
